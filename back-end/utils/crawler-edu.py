...
class UNDocumentCrawler:
       ...
       # Find all symbol blocks containing download links and metadata
        ...
        for block in symbol_blocks:
            try:
                ...
                if self.jump_when_restart and os.path.exists(self.download_dir + symbol.replace('/', '-').replace(' ', '-')):
                    continue
    ...
    def crawl_documents(self):
        ...
        except Exception or UnexpectedAlertPresentException:
            alert = Alert(driver)
            alert.accept()
...
if __name__ == "__main__":
    crawler = UNDocumentCrawler(
        ...
        symbol="*RES",
        subject="",
        pub_date_from="01/01/2025",
        pub_date_to="31/03/2025",
        search_text="educat* OR school* OR learn*",
        language="English",
        search_type="Use boolean operators",
        file_extensions=["pdf", "doc"],
        jump_when_restart=True,
        download_dir="/home/yingqiang/Desktop/work/LiRI/Spirituality-Education-New/"
    )
